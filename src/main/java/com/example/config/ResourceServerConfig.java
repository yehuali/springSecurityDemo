...
import com.example.core.oauth2.config.annotation.web.configuration.EnableResourceServer;
import com.example.core.oauth2.config.annotation.web.configuration.ResourceServerConfigurerAdapter;
